   ...
   <div className='relative overflow-x-auto'>
    ...
    <div className='w-full pl-5'>
        <div className='bg-[#6a5fdf] h-screen lg:h-auto px-3 py-2 lg:rounded-md text-[#d0d2d6]'>
            ...
            <h1 className='text-[#d0d2d6] font-semibold text-xl mb-4 w-full text-center '>Thêm danh mục sản phẩm</h1>
            ...
            <form onSubmit={add_category}>
                <div className='flex flex-col w-full gap-1 mb-3'>
                    ...
                    <input value={state.name} onChange={(e)=>setState({...state,name : e.target.value})} className='px-4 py-2 focus:border-indigo-500 outline-none bg-[#ffffff] border border-slate-700 rounded-md text-[#000000]' type="text" id='name' name='category_name' placeholder='Tên danh mục' />
                 </div>
                 <div>
