...
const Products = () => {
    ...
    return (
        <div className='px-2 lg:px-7 pt-5'>
            <h1 className='text-[#000000] font-semibold text-lg mb-3'>Tất cả sản phẩm</h1>
    ...
    <table className='w-full text-sm text-left text-[#d0d2d6]'>
        ...
        <tr>
            ...
            <th scope='col' className='py-3 px-4'>Số lượng kho</th>
        ...
        <tbody>
            {
                ...
                <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>
                    {
                        d.discount === 0 ? <span>Không giảm giá</span> : 
