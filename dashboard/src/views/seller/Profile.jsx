...
<div className='w-full flex flex-wrap'>
    <div className='w-full md:w-6/12'>
        ...
        <div className='px-0 md:px-5 py-2'>
            ...
            <div className='flex flex-col w-full gap-1 mb-2'>
                <label htmlFor="division">Tên bộ phận</label>
            ...
            <div className='flex flex-col w-full gap-1 mb-2'>
                ...
                <label htmlFor="sub">tên phụ của quận</label>
    ...
    <div className='w-full md:w-6/12'>
        ...
        <form>
            ...
            <button className='bg-red-500  hover:shadow-red-500/40 hover:shadow-md text-white rounded-md px-7 py-2 my-2'>Lưu thay đổi</button>
                </form>
        </div>
