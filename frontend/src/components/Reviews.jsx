    ...
    <div> 
        {
            userInfo ? <div className='flex flex-col gap-3'>
                ...
                <div className='mt-2'>
            <button className='py-1 px-5 bg-indigo-500 text-white rounded-sm'>Gửi</button>
                </div> 
                 
                 </form>
            </div> : <div>
                <Link to='/login' className='py-1 px-5 bg-red-500 text-white rounded-sm'> Đăng nhập trước </Link>
            </div>
        }
    </div>
</div>
