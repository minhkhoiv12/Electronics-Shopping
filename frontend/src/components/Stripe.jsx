        ...
        <div className='mt-4'>
            {
                ...
                ) : <button onClick={create_payment} className='px-10 py-[6px] rounded-sm hover:shadow-green-700/30 hover:shadow-lg bg-green-700 text-white'>Bắt đầu thanh toán</button>
            }
        </div>
    );
}; 
