    ...
    <section>
        ...
        <div className='flex flex-col gap-5'>
         ...
         <div className='text-2xl text-red-500 font-bold flex gap-3'>
          ...
          <div className='text-slate-600'>
            ...
            <p className='text-slate-600 py-1 font-bold'>Tên shop : {product.shopName}</p>
           </div> 
        ...
        <div className='flex bg-slate-200 h-[50px] justify-center items-center text-xl'>
            ...
            <div onClick={inc} className='px-6 cursor-pointer'>+</div>
                    ...
                    <div>
                        <button onClick={add_card} className='px-8 py-3 h-[50px] cursor-pointer hover:shadow-lg hover:shadow-green-500/40 bg-[#059473] text-white'>Thêm vào giỏ hàng</button>
                    </div>
    ...
    <ul className='flex justify-start items-center gap-3'>
        ...
        <li>
          ...
          <div className='flex gap-3'>
                {
                    product.stock ? <button onClick={buynow} className='px-8 py-3 h-[50px] cursor-pointer hover:shadow-lg hover:shadow-green-500/40 bg-[#247462] text-white'>Mua ngay bây giờ</button> : ''
                }
           ...
           <div className='flex flex-wrap'>
            <div className='w-[72%] md-lg:w-full'>
                <div className='pr-4 md-lg:pr-0'>
                    ...
                    <button onClick={() => setState('reviews')} className={`py-1 hover:text-white px-5 hover:bg-[#059473] ${state === 'reviews' ? 'bg-[#059473] text-white' : 'bg-slate-200 text-slate-700'} rounded-sm`}>Đánh giá </button>
                    
                    <button onClick={() => setState('description')} className={`py-1 hover:text-white px-5 hover:bg-[#059473] ${state === 'description' ? 'bg-[#059473] text-white' : 'bg-slate-200 text-slate-700' } rounded-sm`}>Mô tả </button>
                    </div>
    <div>
        {
