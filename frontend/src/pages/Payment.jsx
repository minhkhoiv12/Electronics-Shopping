    ...
    <section className='bg-[#eeeeee]'>
           ...
           }
        {
            paymentMethod === 'cod' && <div className='w-full px-4 py-8 bg-white shadow-sm'>
                <button className='px-10 py-[6px] rounded-sm hover:shadow-green-500/20 hover:shadow-lg bg-[#059473] text-white'>Thanh toán ngay</button>
            </div>
        }
        ...
        <div className='flex justify-between items-center'>
            <span>{items} Các mặt hàng và phí vận chuyển đã bao gồm </span>
            <span>${price} </span>
        </div>
