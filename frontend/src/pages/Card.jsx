...
const Card = () => {
        ...
        <div>
           ...
           <section className='bg-[url("http://localhost:3000/images/banner/shop.png")] h-[220px] mt-6 bg-cover bg-no-repeat relative bg-left'>
            <div className='absolute left-0 top-0 w-full h-full bg-[#2422228a]'>
                ...
                <h2 className='text-3xl font-bold'>Trang giỏ hàng </h2>
   ...
   <div className='flex justify-between w-5/12 sm:w-full sm:mt-3'>
       ...
       <div className='flex gap-2 flex-col'>
           ...
           <button onClick={() => dispatch(delete_card_product(pt._id)) } className='px-5 py-[3px] bg-red-500 text-white'>Xoá</button>
       </div>
   </div>
                   </div>)
                   }
                ...
                } 
                {
                    outofstock_products.length > 0 && <div className='flex flex-col gap-3'>
                         <div className='bg-white p-4'>
                    <h2 className='text-md text-red-500 font-semibold'>Hết hàng {outofstock_products.length}</h2>
                            </div>
                  <div className='bg-white p-4'>
                  {
                       ...
                       <span className='text-sm'>Thương hiệu: {p.products[0].brand}</span>
                       </div>
                           </div>
                       </div>
   <div className='flex justify-between w-5/12 sm:w-full sm:mt-3'>
       ...
       <div className='flex gap-2 flex-col'>
           ...
           <button onClick={() => dispatch(delete_card_product(p._id)) }  className='px-5 py-[3px] bg-red-500 text-white'>Xoá</button>
       </div>
   </div>
