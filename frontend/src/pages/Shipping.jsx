...
const Shipping = () => {
  ...
  return (
    <div>
      <Header />
      <section className='bg-[url("https://hqk-shop.vercel.app/images/banner/shop.png")] h-[220px] mt-6 bg-cover bg-no-repeat relative bg-left'>
                  ...
                  {res && (
                    <div className="flex flex-col gap-1">
                      ...
                      <p className="text-slate-600 text-sm">
                        Email đến khoitk14033@gmail.com
                      </p>
                    </div>
                  )}
                </div>
              ...
              <div className="pl-3 md-lg:pl-0 md-lg:mt-5">
                <div className="bg-white p-3 text-slate-600 flex flex-col gap-3">
                  ...
                  <div className="flex justify-between items-center">
                    <span>Số lượng đơn hàng (items) </span>
                    <span>${price}</span>
                  </div>
                  <div className="flex justify-between items-center">
