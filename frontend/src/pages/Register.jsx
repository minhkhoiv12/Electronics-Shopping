        ...
        <div className="w-full justify-center items-center p-10">
          <div className="grid grid-cols-2 w-[60%] mx-auto bg-white rounded-md">
            <div className="px-8 py-8">
              ...
              <a
                target="_blank"
                href="https://ecomerce-dashboard-kappa.vercel.app/login"
              >
              ...
              <a
                target="_blank"
                href="https://ecomerce-dashboard-kappa.vercel.app/register"
              >
            ...
            <div className="w-full h-full py-4 pr-4">
              <img src="https://hqk-shop.vercel.app/images/login.jpg" alt="" />
            </div>
          </div>
        </div>
      </div>
