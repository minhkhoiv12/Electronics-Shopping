    ...
    return (
        <div>
           ...
           <section className='bg-[url("http://localhost:3000/images/banner/shop.png")] h-[220px] mt-6 bg-cover bg-no-repeat relative bg-left'>
            <div className='absolute left-0 top-0 w-full h-full bg-[#2422228a]'>
                ...
                <h2 className='text-3xl font-bold'>Trang loại sản phẩm </h2>
        ...
        <div className='flex justify-center items-center gap-3'>
            <select onChange={(e)=>setSortPrice(e.target.value)} className='p-1 border outline-0 text-slate-600 font-semibold' name="" id="">
                ...
                <option value="low-to-high">sắp xếp từ thấp đến cao</option>
                <option value="high-to-low">sắp xếp từ cao đến thấp </option>
            </select>
